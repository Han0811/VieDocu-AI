...
def get_args_parser():
    ...
    parser.add_argument('--num_layers_RNN', default=1, type=int, help='number of layers in RNN module')
    parser.add_argument('--hidden_dim_RNN', default=256, type=int, help='hidden dimension of RNN module')
    ...
    VIET = subparsers.add_parser("VIET",
                                 description='Dataset parser for training on Vietnamese handwriting',
                                 add_help=True,
                                 formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                 help="Dataset parser for training on Vietnamese handwriting")

    VIET.add_argument('--train-data-list', type=str, default='./data/viet_hf/train.ln',
                      help='train data list (ln file)')
    VIET.add_argument('--data-path', type=str, default='./data/viet_hf/lines/',
                      help='folder containing line images and txt labels')
    VIET.add_argument('--val-data-list', type=str, default='./data/viet_hf/valid.ln',
                      help='val data list')
    VIET.add_argument('--test-data-list', type=str, default='./data/viet_hf/test.ln',
                      help='test data list')
    VIET.add_argument('--nb-cls', default=512, type=int,
                      help='nb of classes, keep larger than Vietnamese charset + CTC blank')
